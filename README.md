...
`https://elnakouzimohamed.github.io/portfoilo/`

## Run Locally

```powershell
cd "c:\Users\MAKOUZI\Desktop\All pdfs\Mechatronics Engineering\Extra\Portfoilo"
npm install
npm run dev
```
...
- The project is configured for the repo path `/portfoilo`.
